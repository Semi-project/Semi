...
<div class="board_view_subject">
            ...
            <p class="board_view_subject_left">${freeboardService.boardno }.글제목 : ${freeboardService.title }</p>
            <p class="board_view_subject_right"  >|${freeboardService.userid }|${freeboardService.insert_Dat }|${freeboardService.hit }
            </p>
            <p align="right" id="recommend">${freeboardService.recommend }</p>
