...
#btn:hover {
	...
	background-image: -webkit-gradient(linear, left top, left bottom, from(#F3969A),
		to(#ee686e));
	background-image: -webkit-linear-gradient(top, #F3969A, #ee686e);
	background-image: -moz-linear-gradient(top, #F3969A, #ee686e);
	background-image: -ms-linear-gradient(top, #F3969A, #ee686e);
	background-image: -o-linear-gradient(top, #F3969A, #ee686e);
	background-image: linear-gradient(to bottom, #F3969A, #ee686e);
	filter: progid:DXImageTransform.Microsoft.gradient(GradientType=0,
		startColorstr=#F3969A, endColorstr=#ee686e);
}
</style>
<script>
