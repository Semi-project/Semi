...
<script>
	$(document).ready(
			function() {
				...
				$("#merchant_uid").val(
						'${param.animalName }' + '_' + '${param.animalCode }'
								+ '_' + new Date().getTime());
				$("#back").click(function() {
					history.go(-1);
				});
...
<body>
	<div class="row ">
		...
		<div class="col-lg-8">
			<div class="col-lg-12">
				<div class="charity" id="step1"><span>후원종류 선택</span></div>
				<div class="charity" id="step2">
					<span>후원자정보 <br> 입력 및 결제</span>
				</div>
			...
			<table id="charity" style="margin: 0 auto;">
				...
				<tr>
					<th>결제명</th>
					<td><input type="text" id="name" value="${param.animalCode }"
						readonly="readonly"></td>
				</tr>
				<tr>
					<th>금액</th>
