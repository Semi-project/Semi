...
<script>
	$(document).ready(function() {
		$(".btn_order").click(function() {
			if($('input:checkbox[id="ok1"]').is(":checked")==false || $('input:checkbox[id="ok2"]').is(":checked")==false){
				$('input:checkbox[id="ok1"]').focus();
				alert("약관에 동의해주세요");
			}else{
...
제24조(재판권 및 준거법)
 ...
 ②“몰”과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
					...
					<tr>
						<td><input id="ok1" type="checkbox">이용약관에 동의합니다.<br>
							<br> <br> <br></td>
					</tr>
					<tr>
						<td>
...
'정보통신망 이용촉진 및 정보보호 등에 관한 법률'의 거래기록 보존 의무에 따른 보존: 1년
					...
					<tr>
						<td><input id="ok2" type="checkbox">개인정보 수집 및 이용에 대한
							안내에 동의합니다.</td>
					</tr>
				</table>
