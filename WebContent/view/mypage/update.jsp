...
<label>이메일<input type="text" name="email" value="${memberView.email }" /></label><br>
 <label>휴대전화 <input type="text" name="phone" value="${memberView.phone }" /></label><br>
  <label>주소 <input type="text" name="address" value="${memberView.address }" /></label><br>
<button id="btnUpdate" class="btn btn-info" onclick='location.href="/view/mypage/view.jsp";'>수정하기</button>
