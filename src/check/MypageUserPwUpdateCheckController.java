...
@WebServlet("/mypage/updatepasswordcheck")
public class MypageUserPwUpdateCheckController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("/view/check/updatecheck.jsp").forward(req , resp);
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if( flag == true) {
			...
			resp.sendRedirect("/mypage/userpwupdate");
		}else {
