...
public class Notice_Board_param {
	...
	public Notice_Board_param() {}

	public Notice_Board_param(int boardno, int cateno, String title, String content, Date insert_Dat, Date update_Dat,
